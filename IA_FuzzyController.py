...
class IA_FuzzyController:
    def __init__(self, maze_tile_size):
        ...
        loin_gauche = [-perception_distance, -perception_distance, -perception_distance*0.35, -perception_distance*0.3]
        proche_gauche = [-perception_distance*0.35, -perception_distance*0.25, 0, 0]
        ...
        loin_bas = [-perception_distance, -perception_distance, -perception_distance*0.35, -perception_distance*0.3]
        proche_bas = [-perception_distance*0.35, -perception_distance*0.25, 0, 0]
