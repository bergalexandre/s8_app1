...
class IA_FuzzyController_left_right:
    def __init__(self, maze_tile_size):
        ...
        wall_antecedent = ctrl.Antecedent(np.linspace(-perception_distance, perception_distance, 1000), 'wall_x')
        wall_antecedent = ctrl.Antecedent(np.linspace(-perception_distance, perception_distance, 1000), 'wall_y')
        ...
        wall_antecedent["loin_bas"] = fuzz.trapmf(wall_antecedent.universe, loin_gauche)
        wall_antecedent["proche_bas"] = fuzz.trapmf(wall_antecedent.universe, proche_gauche)
        wall_antecedent["proche_haut"] = fuzz.trapmf(wall_antecedent.universe, np.flip(np.abs(proche_gauche)))
        wall_antecedent["loin_haut"] = fuzz.trapmf(wall_antecedent.universe, np.flip(np.abs(loin_gauche)))

        obstacle_antecedent["loin_bas"] = fuzz.trapmf(obstacle_antecedent.universe, loin_gauche)
        obstacle_antecedent["proche_bas"] = fuzz.trapmf(obstacle_antecedent.universe, proche_gauche)
        obstacle_antecedent["proche_haut"] = fuzz.trapmf(obstacle_antecedent.universe, np.flip(np.abs(proche_gauche)))
        obstacle_antecedent["loin_haut"] = fuzz.trapmf(obstacle_antecedent.universe, np.flip(np.abs(loin_gauche)))

        movement_consequence['bas'] = fuzz.trapmf(movement_consequence.universe, [-1, -1, -0.3 , 0])
        movement_consequence['milieu'] = fuzz.trimf(movement_consequence.universe, [-0.3,0,0.3])
        movement_consequence['haut'] = fuzz.trapmf(movement_consequence.universe, [0, 0.3, 1, 1])
        ...
        #rules
        rules = []
        rules.append(ctrl.Rule(antecedent=(wall_antecedent['loin_gauche'] & obstacle_antecedent['loin_gauche']), consequent=movement_consequence['milieu']))
        rules.append(ctrl.Rule(antecedent=(wall_antecedent['proche_gauche'] & obstacle_antecedent['loin_gauche']), consequent=movement_consequence['droite']))
        rules.append(ctrl.Rule(antecedent=(wall_antecedent['proche_droite'] & obstacle_antecedent['loin_gauche']), consequent=movement_consequence['gauche']))
        rules.append(ctrl.Rule(antecedent=(wall_antecedent['loin_droite'] & obstacle_antecedent['loin_gauche']), consequent=movement_consequence['milieu']))

        rules.append(ctrl.Rule(antecedent=(wall_antecedent['loin_gauche'] & obstacle_antecedent['proche_gauche']), consequent=movement_consequence['droite']))
        rules.append(ctrl.Rule(antecedent=(wall_antecedent['proche_gauche'] & obstacle_antecedent['proche_gauche']), consequent=movement_consequence['droite']))
        rules.append(ctrl.Rule(antecedent=(wall_antecedent['proche_droite'] & obstacle_antecedent['proche_gauche']), consequent=movement_consequence['milieu']))
        rules.append(ctrl.Rule(antecedent=(wall_antecedent['loin_droite'] & obstacle_antecedent['proche_gauche']), consequent=movement_consequence['gauche']))

        rules.append(ctrl.Rule(antecedent=(wall_antecedent['loin_gauche'] & obstacle_antecedent['proche_droite']), consequent=movement_consequence['gauche']))
        rules.append(ctrl.Rule(antecedent=(wall_antecedent['proche_gauche'] & obstacle_antecedent['proche_droite']), consequent=movement_consequence['milieu']))
        rules.append(ctrl.Rule(antecedent=(wall_antecedent['proche_droite'] & obstacle_antecedent['proche_droite']), consequent=movement_consequence['gauche']))
        rules.append(ctrl.Rule(antecedent=(wall_antecedent['loin_droite'] & obstacle_antecedent['proche_droite']), consequent=movement_consequence['gauche']))

        rules.append(ctrl.Rule(antecedent=(wall_antecedent['loin_gauche'] & obstacle_antecedent['loin_droite']), consequent=movement_consequence['milieu']))
        rules.append(ctrl.Rule(antecedent=(wall_antecedent['proche_gauche'] & obstacle_antecedent['loin_droite']), consequent=movement_consequence['droite']))
        rules.append(ctrl.Rule(antecedent=(wall_antecedent['proche_droite'] & obstacle_antecedent['loin_droite']), consequent=movement_consequence['gauche']))
        rules.append(ctrl.Rule(antecedent=(wall_antecedent['loin_droite'] & obstacle_antecedent['loin_droite']), consequent=movement_consequence['milieu']))
